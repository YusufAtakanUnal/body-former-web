...
export const content = {
  tr: {
    ...
    coin: {
      ...
      graphTitle: "Değer döngüsü, tek bakışta",
      graphLead: "Kullanıcı, BodyFormer ve supplement markası arasında akan değer — ağırlıklı kenarlarla.",
      nodes: { user: "Kullanıcı", brand: "Supplement Markası" },
      edges: {
        userToBf: "$5/ay · 8 foto",
        bfToUser: "16 ölçüm · rank",
        userCoin: "Coin",
        brandToBf: "Ürün stoğu",
        bfToBrand: "Komisyon %15",
  ...
  en: {
    ...
    coin: {
      ...
      graphTitle: "The value loop, at a glance",
      graphLead: "Value flowing between the user, BodyFormer and supplement brands — as weighted edges.",
      nodes: { user: "User", brand: "Supplement Brand" },
      edges: {
        userToBf: "$5/mo · 8 photos",
        bfToUser: "16 metrics · rank",
        userCoin: "Coin",
        brandToBf: "Product stock",
        bfToBrand: "15% commission",
